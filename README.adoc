...
image:https://maven-badges.herokuapp.com/maven-central/uk.co.blackpepper.bowman/bowman-client/badge.svg[title=Maven Central,link=https://maven-badges.herokuapp.com/maven-central/uk.co.blackpepper.bowman/bowman-client]
